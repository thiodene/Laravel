...
<div class="bgGrey">
    <div class="container">
        <div class="row">
            <div class="col-12">
              <h1 class="heading_grey h3 mt-0" tabindex="0">Analytics Dashboard - {{ $app->name_en }}</h1>
            </div>
            @if(session('success'))
        ...
        <div class="col-lg-9 col-12 pl-lg-4">
            <div class="container p-0">
                <div class="row">
                    ...
                    <h3 class="h4 col-12 pl-0">Total Subscribers</h3>
                    <div style="font-size: 48px;">{{ $num_subscribers }}</div>
